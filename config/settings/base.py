...
LOCAL_APPS = [
    "code_test.flight_data.apps.FlightDataConfig"
]
...
MIGRATION_MODULES = {
    "sites": "code_test.contrib.sites.migrations"
}
...
REST_FRAMEWORK = {
    ...
    # 1000 > 100
    'PAGE_SIZE': 1000  # TODO - might be worth fine-tuning on a view-per-view basis
}
